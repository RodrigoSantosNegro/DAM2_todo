...
class WallAPIAllCommentsEndpointTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        file.write('[{"model": "wallrest26app.entry", "pk": 1, "fields": {"title": "Title1", "content": "Content1", "publication_date": "2022-07-13T10:58:27Z"}}, {"model": "wallrest26app.entry", "pk": 2, "fields": {"title": "Title2", "content": "Content2", "publication_date": "2022-07-13T11:04:50Z"}}, {"model": "wallrest26app.comment", "pk": 1, "fields": {"content": "'+self.r1+'", "entry": 1}}, {"model": "wallrest26app.comment", "pk": 2, "fields": {"content": "'+self.r2+'", "entry": 1}}, {"model": "wallrest26app.comment", "pk": 3, "fields": {"content": "'+self.r3+'", "entry": 2}}]')
        file.close()
