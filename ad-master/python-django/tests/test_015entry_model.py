...
class WallAPIEntryModelExistsTestCase(unittest.TestCase):
    ...
    def test_entry_model(self):
        models_filename = context.WALL_API_ROOT + "wallrest26app/models.py"
    ...
    def __expected_lines_content(self):
        ...
        return [
            ...
            {"line": "models.CharField(max_length=180)", "found": False},
            {"line": "models.CharField(max_length=4500)", "found": False},
