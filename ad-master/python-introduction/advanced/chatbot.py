class ChatBot:
    ...
    def test_two_params(self, num1, num2):
        print(num1 - num2)

    def __init__(self):
        print("ChatBot listo para el combate")
        self.name = "Hyperion"
        self.knowledge = {
            ...
            "color": "Ojalá yo tuviera ojos para ver los colores",
            "dinero": "Si hay algo que sé es que el dinero no da la felicidad. Y no sé mucho...",
            "favor": "Yo no hago favores",
            "humano": "Los humanos siempre os preocupáis por vuestras cosas",
            "inteligencia": "¿Inteligencia? No me hables de inteligencia...",
            "interesante": "Para cosas interesantes, el Discovery Channel",
            "máquina": "¿Has visto la película Terminator? Quizás deberías...",
            "ordenador": "Los ordenadores somos máquinas muy útiles",
