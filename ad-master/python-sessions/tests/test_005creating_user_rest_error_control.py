...
class IdeAPIRegisterNotHappyPathTestCase(unittest.TestCase):
    ...
    def test_missing_param_password(self):
        def test_body():
            ...
            self.__assert_post_endpoint("v1/users", request_body_missing_param, {"error": "Missing parameter in JSON"}, 400)
    ...
    def test_email_not_valid_due_to_missing_character(self):
        def test_body():
            ...
            self.__assert_post_endpoint("v1/users", request_body_invalid_email, {"error": "Email not valid"}, 400)
    ...
    def test_email_not_valid_due_to_length_restriction(self):
        def test_body():
            ...
            self.__assert_post_endpoint("v1/users", request_body_short_email, {"error": "Email not valid"}, 400)
    ...
    def test_already_registered(self):
        ...
        command = 'sqlite3.exe apis/IdeAPI/db.sqlite3 "INSERT INTO idearest26app_customuser (e_mail, username, encrypted_password) VALUES (\'' + valid_email + '\', \'Test User\', \'$2b$12$l2NvEv5Fm7abtLDhWNyKu.pL3orDvp700e8vaLJPfTDKnptWsflV.\')"'
        ...
        def send_request():
            ...
            self.__assert_post_endpoint("v1/users", request_body, {"error": "Email already registered"}, 409)
    ...
    def __test_with_server_alive(self, block):
        ...
        def app_dir_exists():
            return os.path.isdir(context.IDEAPI_ROOT + "idearest26app")
