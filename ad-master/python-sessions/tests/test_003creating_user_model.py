...
class IdeAPICustomUserModelTestCase(unittest.TestCase):
    ...
    def test_db_was_migrated(self):
        ...
        command = 'sqlite3.exe apis/IdeAPI/db.sqlite3 "SELECT COUNT(e_mail) FROM idearest26app_customuser WHERE id=-1"'
    ...
    def __expected_lines_content(self):
        ...
        return [
            ...
            {"line": "models.CharField(max_length=230, unique=True)", "found": False},
            {"line": "models.CharField(max_length=240)", "found": False},
