...
public class T013GenericDramaInsertion {
    ...
    public void testCorrectInsert() {
        ...
        try {
            ...
            ResultSet result = statement.executeQuery("SELECT COUNT(*) FROM TMovies WHERE genre = 'drama'");
            while(result.next()) {
        ...
        try {
            ...
            Method method = cls.getDeclaredMethod("createDrama", String.class, int.class, int.class, String.class, String.class);
    ...
    public void testCorrectInsertMultipleRandom() {
        ...
        try {
            ...
            // Crear y ejecutar la consulta
            Statement statement = conn.createStatement();
            ResultSet result = statement.executeQuery("SELECT COUNT(*) FROM TMovies WHERE title = '"+ randomName+"' AND genre = 'drama'");
            while(result.next()) {
    ...
    public void testAllCorrectValuesInserted() {
        ...
        try {
            ...
            // Crear y ejecutar la consulta
            Statement statement = conn.createStatement();
            ResultSet result = statement.executeQuery("SELECT COUNT(*) FROM TMovies WHERE title = '"+ test3Title+"' AND genre = 'drama' AND year = "+test3Year+" AND duration = "+test3Duration+" AND synopsis = '"+test3Synopsis+"' AND countryIso3166='"+test3CountryCode+"'");
            while(result.next()) {
                previousNumberOfTitlesRandomInsert = result.getInt(1);
            }
            conn.close();
