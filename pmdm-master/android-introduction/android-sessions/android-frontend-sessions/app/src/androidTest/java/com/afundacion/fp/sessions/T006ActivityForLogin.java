...
public class T006ActivityForLogin extends TestRun {
    ...
    public void checkEditTextUsernameIsCorrect() {
        Espresso.onView(editTextWithHint("william.doe")).check(isCenteredOnParent());
        Espresso.onView(editTextWithHint("Contraseña")).check(isTopToBottomOf(editTextWithHint("william.doe")));
        Espresso.onView(editTextWithHint("william.doe")).check(isLeftAlignedWith(editTextWithHint("Contraseña")));
        Espresso.onView(editTextWithHint("william.doe")).check(isRightAlignedWith(editTextWithHint("Contraseña")));
        Espresso.onView(editTextWithHint("william.doe")).perform(typeText("hola, hola"));
        Espresso.onView(editTextWithHint("william.doe")).check(hasDeclaredId());
    }
    ...
    public void checkButtonsAreCorrect() {
        ...
        Espresso.onView(withText("Login")).check(isTopToBottomOf(withText("¿No tienes cuenta?")));
    }
    ...
    public void checkGoToRegisterButtonWorksForthAndBack() throws JSONException {
        ...
        String randUser = "Dev26User" + (new Date()).getTime();
        String randPass = "Dev26Pass" + (new Date()).getTime();
        ...
        Matcher<View> toast = withText(containsString("Usuario creado con éxito"));
