...
public class T018ThirdFragment {
    ...
    public void checkCorrectImageShownAfterClick() {
        ...
        Matcher<View> contentDescription = withContentDescription("Un último Digimon muy fuerte");
    ...
    public void checkCorrectImageShownAfterClickAndNotOther() {
        Matcher<View> contentDescription1 = withContentDescription("Un Digimon muy fuerte");
        Matcher<View> contentDescription2 = withContentDescription("Un último Digimon muy fuerte");
