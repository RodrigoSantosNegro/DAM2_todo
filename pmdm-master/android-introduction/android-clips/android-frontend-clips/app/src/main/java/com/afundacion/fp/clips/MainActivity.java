        ...
        JsonObjectRequest request = new JsonObjectRequest(
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            Toast.makeText(context, "GET OK: " + response.getString("status"), Toast.LENGTH_SHORT).show();
    ...
    private void getClips(){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressBar.setVisibility(View.INVISIBLE);
                        if(error.networkResponse == null) Snackbar.make(mainLayout, "Unable to reach server", Snackbar.LENGTH_SHORT).show();
                        else {
                            int serveCode = error.networkResponse.statusCode;
                            Snackbar.make(mainLayout, "Server responded with " + serveCode, Snackbar.LENGTH_SHORT).show();
                        }
